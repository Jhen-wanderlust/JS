...
$( "#target" ).val(listData2).keypress();
function edValueKeyPress() {
  var edValue = document.getElementById("target");
  var s = edValue.value = "ITM314";
...
function simulateClick() {
  ...
  const cb = document.getElementById('itmdsc');
