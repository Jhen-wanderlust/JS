...
//Sales Top List Checkboxes to click
...
let listData = ['07-08-2019', '07-08-2020']
...
var data = [
  ...
  'table_paymentgrp',
  'table_byitembycus',
  'table_byitemclssfctn',
  'table_bycusbyitem',
  'table_bycusbyitemclass',
  'table_byterrbyitemclass',
  'table_bybrand',
]

var counter = localStorage.getItem('data7')

document.querySelector('#report_type').value= data[counter];
...
func_printbyreport_type('pdf');



load_page('rep_sales_and_col.php','367');
...
document.querySelector('#txtreptyp').value= data[counter];
...
//receivables report
//for date
let listData = ['08-03-2019', '08-06-2019']
...
datalist = {
  ...
  Customer_From: 'ABC Marketing',
  Customer_To: 'Acme Minimart',
...
datalist = {
  Doc_No_From : 'ARR-0000002',
  Doc_No_to: 'ARR-0000006',
